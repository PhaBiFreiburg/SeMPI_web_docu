...
#. cluster_df.db contains all infos about the detected gene clusters.
#. cluster_scoring_df.db contains all infos about the natural product screening.
#. gbk_df.db contains all infos about the detected domains.
#. meta_df.db contains all meta infos such as file name and description.
...
This only work when a server is simulated. This can be done with python:
Just run: 
